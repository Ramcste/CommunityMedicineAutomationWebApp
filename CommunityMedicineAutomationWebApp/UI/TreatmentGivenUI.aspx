<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TreatmentGivenUI.aspx.cs" Inherits="CommunityMedicineAutomationWebApp.UI.TreatmentGivenUI" %>
...
<body>
    ...
    <div class="container">
        ...
        <h1>Welcome to the Treatment</h1>
    </div>
    </form>
</body>
</html>
